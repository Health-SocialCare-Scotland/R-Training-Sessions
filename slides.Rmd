...
The dplyr package also makes it very easy to join data by matching files together using common variables. There are several join functions within dplyr that are designed to merge dataframes together to create one dataframe containing the relevant variables.
...
- Filter your data to select records with HospitalCode "B109H". Create a histogram for patient's length of stay. Add a title and axis labels and save the plot to your plots folder as a PNG. Hint: Use hist() to create the histogram
