...
very similar to reading in data e.g.

- `readr::write_csv(object, "file_name.csv")`
- `haven::write_sav(object, "file_name.sav")`
...
```{r,  eval=FALSE,echo=TRUE}
barplot(counts, col = "blue", space = 1)
```
...
barplot(counts,
  ...
  main = "Distribution of Admission Day"
)
```
...
Hint: Use `hist()` to create the histogram
